...
ngMigration Assistant Electron is an easy-to-use desktop app that scans an AngularJS application and recommends how to migrate to Angular. Click <a href = "./ngmaDesktop" download = "ngmaDesktop">here</a> to download ngmaDesktop.
